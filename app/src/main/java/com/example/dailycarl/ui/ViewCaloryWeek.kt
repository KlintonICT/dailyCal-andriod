 ...
 *
 * View remaining Calories in Week mode
 */
...
class ViewCaloryWeek : Fragment() {
     ...
     *          date: String
     *
     * Find range of dates in the weeks of the selected month
     * Calculate calories in that week
     */
    private fun calculationWeek(viewRoot: View, date: String){
        var userId = ""
        var currentUser = mAuth!!.currentUser
        currentUser?.let { userId = currentUser.uid }
        /** retrieve actities information from the Users**/
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onDataChange(dataSnapshot: DataSnapshot) {
                    ...
                    for(snapshot in dataSnapshot.children){
                        ...
                        if(monthYear ==  date){
                            /** calculate total calories of Exercise Activities in each week**/
                            ...
                            /** calculate total calories of Eat Activities in each week**/
    ...
    /**
     * @param:  viewRoot:       View,
     *          totalEx:        Array<Double>,
     *          totalExGoal:    Array<Double>,
     *          totalFood:      Array<Double>,
     *          totalFoodGoal:  Array<Double>
     *
     * displat table of remaining calories in each week
     */
