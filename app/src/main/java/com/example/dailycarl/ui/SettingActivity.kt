 ...
 *
 * Editing profile page and change language
 */
...
class SettingActivity : Fragment() {
     ...
     *@return: View
     *
     * Retrieve the current user profile information from the database
     */
    ...
    override fun onCreateView(
        ...
        /** If the user clicks update button, data in database will be update**/
    ...
    /** Let the user choose profile picture**/
     ...
     *          data: Intent?
     *
     * Perform task according to selected menu
     */
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        /** Show picture taken from camera**/
