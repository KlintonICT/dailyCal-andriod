 ...
 *
 * Let user records Eat or Exercise activity information
 * Add location, Image, Text
 * Check the conditions
 * Record in Real Time database
 */
...
class EatAndExActivity : AppCompatActivity() {
     ...
     *
     * Create Textbox for users to fill in information
     */
    ...
    /**Check the type of activity whether it is Eat or Exercise**/
        ...
        /** Show Calendar for user to pick the date**/
     ...
     *          location:   String
     *
     * When the OK button is clicked, check whether information is filled in.
     */
    ...
    /**
     * Show the dialog to let user choose how to add image: gallery or camera
     */
    ...
    /** Pass GALLERY to onActivityResult**/
    private fun chooseImageFromGallery() {
        val galleryIntent = Intent(Intent.ACTION_PICK,MediaStore.Images.Media.EXTERNAL_CONTENT_URI)
        startActivityForResult(galleryIntent, GALLERY)
    }
    /** Pass Camera to onActivityResult**/
    private fun takePhotoFromCamera() {
        val cameraIntent = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        startActivityForResult(cameraIntent, CAMERA)
    }
    /**
     * @param:  reqeuestCode:      Int
     *          resultCose:        Int
     *          data:              Intent?
     *
     * Show the result from menu that user selected
     */
     ...
     *
     * encode image to Base64 and save in Real Time Database
     */
