 ...
 *
 * View remaining Calories in Day mode
 */
...
class ViewCaloriesActivity : Fragment(){
     ...
     * @return: View
     *
     * Retrieve information from the selected date
     */
    override fun onCreateView(
        ...
        pickDay.text = currentDate //Show the current date
     ...
     *         date: String
     *
     * Replace the current date information with the selected date information at the same page
     */
    private fun renderRecycleView(viewRoot: View, date: String){
        var userId = ""
        /** retrieve records from the database and display**/
     ...
     *         date: String
     *
     * calculate remaining calories from the selected date
     */
     ...
     *          exGoal:     Double
     *
     * display Exercise pie graph with animation
     */
    private fun exercisePieChart (viewRoot: View, exCal: Double, exGoal: Double){
        ...
        /** Add animation according to the condition**/
     ...
     *          exGoal:     Double
     *
     * display Food pie graph with animation
     */
    private fun foodPieChart(viewRoot: View, foodCal: Double, foodGoal: Double){
        ...
        var pieData = PieData(pieDataSet)
        pieChart.data = pieData
        pieChart.animateXY(1500, 1500) // rotate animation
    }
