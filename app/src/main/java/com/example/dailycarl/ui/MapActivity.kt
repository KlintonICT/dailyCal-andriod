 ...
 *
 * Search in Google Map and Record location to the activity
 */
...
class MapActivity : AppCompatActivity(){
     ...
     *
     * User Input location name and click search
     */
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /**When user click Search button, get Address location from API**/
